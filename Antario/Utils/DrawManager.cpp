...
void DrawManager::InitDeviceObjects(LPDIRECT3DDEVICE9 pDevice)
{
	...
	g_Fonts.pFontESPFont = std::make_unique<CD3DFont>(L"Verdana", 7, FW_BOLD);
	g_Fonts.pFontESPFont2 = std::make_unique<CD3DFont>(L"smallest_pixel-7", 8, 100);
	g_Fonts.pFontIcons = std::make_unique<CD3DFont>(L"AstriumWep", 11, 100);
